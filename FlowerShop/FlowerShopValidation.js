...
function Submit() {
    var cardnum = document.getElementById("txtCardNumber").value.length;
    var security = document.getElementById("txtSecurityCode").value.length;
    var userName = document.getElementById("txtName").value.length;
    ...
    if (cardnum > 0 && security > 0 && userName > 0 && pin > 0 && mail > 0 && address > 0 && city > 0) {
